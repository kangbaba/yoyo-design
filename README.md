...
Design system specs and AI-assisted prototyping for the YoYo product — a social voice chat app for iOS, Android, and H5 (mobile web).
...
1. Clone this repo:
   ```
   git clone https://github.com/kangbaba/yoyo-design.git
   ```
...
## YoYo component library

Figma library: [YoYo_library](https://www.figma.com/design/GxW7MR9p08qbqCPt5Tzrjw/YoYo_library)

Includes: Bars, Icons, Buttons, Sheets, Cards, Tabs, Lists, Badges & Tags, Feeds, Grid, and more.
